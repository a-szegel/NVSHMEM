 ...
 *
 * Entry 0 (base_request_t): [rwrite_offset_high:32][rwrite_offset_low:8][op:8][group_size:8][flag:8]
 * Entry 1 (put_signal_0):   [laddr_write_high:32][laddr_write_3:16][laddr_write_2:8][flag:8]
 * Entry 2 (put_signal_1):   [write_size_high:32][write_size_low:16][laddr_write_low:8][flag:8]
 * Entry 3 (put_signal_2):   [reserved:32][pe:16][reserved:8][flag:8]
 * Entry 4 (put_signal_3):   [rsigoffset_high:32][rsigoffset_low:8][sig_op:8][sigval_low:8][flag:8]
 * Entry 5 (put_signal_4):   [sigval_high:32][sigval_3:16][sigval_2:8][flag:8]
 *
 */
